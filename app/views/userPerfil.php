    ...
    <div class="profile-container">
        <div class="profile-header">
            ...
            <?php else: ?>
                <?php if ($seguindo): ?>
                    ...
                    <a href="../controllers/seguir.php?id=<?=$usuario_id?>" class="edit-profile">PARAR DE SEGUIR</a>
                <?php else: ?>
                    <a href="../controllers/seguir.php?id=<?=$usuario_id?>" class="edit-profile">SEGUIR</a>
        ...
        <div class="posts-container">
            ...
            $stmt = $pdo->prepare('
                ...
                WHERE posts.user_id = :usuario_id
            ...
            while ($row = $stmt->fetch()) {
                ...
                if ($row['user_id'] == $user_id) {
                    ...
                    echo "                    <input type='hidden' name='from' value='userPerfil'>";
                    echo "                    <input type='hidden' name='profile_id' value='" . $usuario_id . "'>";
                ...
                while ($comment = $comments_stmt->fetch()) {
                    ...
                    if ($comment['user_id'] == $user_id) {
                        echo "<div class='ellipsis-container'>";
                        echo "    <div class='ellipsis' id='ellipsis-btn-" . $comment['id'] . "'>";
                        echo "        &#x2022;&#x2022;&#x2022;";
                        echo "    </div>";

                        echo "    <div class='dropdown' id='dropdown-menu-" . $comment['id'] . "'>";
                        echo "        <ul>";
